...
type workspacesalexanderResumesrccomponentsseoJs63159454QueryVariables = Exact<{ [key: string]: never; }>;


type workspacesalexanderResumesrccomponentsseoJs63159454Query = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title' | 'description' | 'author'>> }> };

type GetSiteBuildTimeQueryVariables = Exact<{ [key: string]: never; }>;


type GetSiteBuildTimeQuery = { readonly site: Maybe<Pick<Site, 'buildTime'>> };
